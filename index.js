...
const { blockAssociateAccess, blockReadOnlyAccess } = require('./middleware/auth');

app.use('/', indexRoutes);
app.use('/auth', authRoutes);
app.use('/dashboard', dashboardRoutes);
app.use('/user', blockReadOnlyAccess, userRoutes);
app.use('/customer', blockReadOnlyAccess, customerRoutes);
app.use('/broker', brokerRoutes);
app.use('/booking', bookingRoutes);
app.use('/payment', paymentRoutes);
app.use('/project', blockReadOnlyAccess, projectRoutes);
app.use('/broker-payment', brokerPaymentRoutes);
app.use('/team', blockReadOnlyAccess, teamRoutes);
app.use('/employee', blockReadOnlyAccess, employeeRoutes);
